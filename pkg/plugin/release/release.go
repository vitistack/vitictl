// Package release queries GitHub for the latest published release of a viti
...
// DefaultTimeout bounds the GitHub API lookup so a plugin's
// `version --check` flag cannot hang a terminal on a slow network.
